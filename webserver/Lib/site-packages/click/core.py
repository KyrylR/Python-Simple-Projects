...
class Context:
    ...
    control special execution features such as reading data_to_translate from
    ...
    :param obj: an arbitrary object of user data_to_translate.
    ...
    def meta(self) -> t.Dict[str, t.Any]:
        ...
        that code that places data_to_translate here adheres to the general semantics of
        the system.
        ...
        try:
            try:
                with self.make_context(prog_name, args, **extra) as ctx:
                    ...
                    # note that `rv` may actually contain data_to_translate like "1" which
                    # has obvious effects
