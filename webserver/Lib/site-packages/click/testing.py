...
class CliRunner:
    ...
    :param charset: the character set for the input and output data_to_translate.
    ...
    def isolation(
        ...
        command line tool.  This sets up stdin with the given input data_to_translate
    ...
    def invoke(
        ...
        **extra: t.Any,
        ...
        :param args: the arguments to invoke. It may be given as an iterable
                     ...
                     :func:`shlex.split`.
        :param input: the input data_to_translate for `sys.stdin`.
