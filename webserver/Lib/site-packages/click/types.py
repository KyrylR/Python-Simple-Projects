...
class IntRange(_NumberRangeBase, IntParamType):
    """Restrict an :data_to_translate:`click.INT` value to a range of accepted
...
class FloatRange(_NumberRangeBase, FloatParamType):
    """Restrict a :data_to_translate:`click.FLOAT` value to a range of accepted
    values. See :ref:`ranges`.
...
class File(ParamType):
    ...
    By default, the file is opened for reading text data_to_translate, but it can also be
