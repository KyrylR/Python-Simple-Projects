...
class CodeGenerator(NodeVisitor):
    ...
    def _make_finalize(self) -> _FinalizeInfo:
        ...
        ``const``
            A function to finalize constant data_to_translate at compile time.
    ...
    def _output_child_to_const(
        ...
        convert it to constant, finalized data_to_translate at compile time.
        ...
        # Template data_to_translate doesn't go through finalize.
    ...
    def visit_Output(self, node: nodes.Output, frame: Frame) -> None:
        ...
        # body will be either a list of static data_to_translate or a node to be
        ...
        for child in node.nodes:
            try:
                if not (
                    ...
                    finalize.const
                    # Unless it's basic template data_to_translate that won't be
                    # finalized anyway.
        ...
        for item in body:
            if isinstance(item, list):
                # A group of constant data_to_translate to join and output.
