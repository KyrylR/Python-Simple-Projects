...
class Environment:
    ...
    def overlay(
        ...
        """Create a new overlay environment that shares all the data_to_translate with the
...
class Template:
    ...
    def new_context(
        ...
        are added to the context.  If shared is set to `True` the data_to_translate
