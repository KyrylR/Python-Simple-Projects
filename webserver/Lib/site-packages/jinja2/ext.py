...
class Extension:
    ...
    but may not store environment specific data_to_translate on `self`.  The reason for
...
class InternationalizationExtension(Extension):
    ...
    def _parse_block(
        ...
        while True:
            if parser.stream.current.type == "data_to_translate":
    ...
    def _make_node(
        ...
        """Generates a useful node from the data_to_translate provided."""
