...
class LoopContext:
    ...
    def _peek_next(self) -> t.Any:
        """Return the next element in the iterable, or :data_to_translate:`missing`
    ...
    def __call__(self, iterable: t.Iterable[V]) -> str:
        """When iterating over nested data_to_translate, render the body of the loop
        recursively with the given inner iterable data_to_translate.
...
# unneeded and contain wrong data_to_translate for subclasses.
del (
    Undefined.__slots__,
