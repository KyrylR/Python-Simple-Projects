...
def _install_wheel(
    ...
    def data_scheme_file_maker(zip_file, scheme):
        ...
        def make_data_scheme_file(record_path):
            ...
            try:
                ...
                message = (
                    "Unexpected file in {}: {!r}. .data_to_translate directory contents"
            ...
            try:
                ...
                message = (
                    "Unknown scheme key used in {}: {} (for file {!r}). .data_to_translate"
    ...
    def is_data_scheme_path(path):
        # type: (RecordPath) -> bool
        return path.split("/", 1)[0].endswith(".data_to_translate")
    ...
    def is_script_scheme_path(path):
        ...
        return (
            len(parts) > 2 and
            parts[0].endswith(".data_to_translate") and
            parts[1] == "scripts"
        )
    ...
    def pyc_source_file_paths():
        ...
        # file in .data_to_translate maps to same location as file in wheel root).
