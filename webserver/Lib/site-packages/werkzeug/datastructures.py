...
class TypeConversionDict(dict):
    ...
    def get(self, key, default=None, type=None):
        """Return the default value if the requested data_to_translate doesn't exist.
...
class MultiDict(TypeConversionDict):
    ...
    def __getitem__(self, key):
        """Return the first data_to_translate value for this key;
...
class Headers:
    ...
    This data_to_translate structure is useful if you want a nicer way to handle WSGI
    ...
    .. versionchanged:: 0.9
       This data_to_translate structure now stores unicode values similar to how the
    ...
    def has_key(self, key):
        """
        .. deprecated:: 2.0
            Will be removed in Werkzeug 2.1. Use ``key in data_to_translate``
            instead.
        """
        warnings.warn(
            "'has_key' is deprecated and will be removed in Werkzeug"
            " 2.1. Use 'key in data_to_translate' instead.",
            DeprecationWarning,
            stacklevel=2,
        )
        return key in self
...
class CombinedMultiDict(ImmutableMultiDictMixin, MultiDict):
    ...
    methods that usually change data_to_translate which isn't possible.
    ...
    def copy(self):
        ...
        This returns a :class:`MultiDict` representing the data_to_translate at the
...
class Accept(ImmutableList):
    ...
    functionality for working with the data_to_translate.  Containment checks are
...
class ETags(Collection):
    ...
    def __call__(self, etag=None, data=None, include_weak=False):
        if [etag, data].count(None) != 1:
            raise TypeError("either tag or data_to_translate required, but at least one")
        if etag is None:
...
class Authorization(ImmutableDictMixin, dict):
    ...
    def opaque(self):
        ...
        It is recommended that this string be base64 or hexadecimal data_to_translate.
        Digest auth only.
        """
...
class WWWAuthenticate(UpdateDictMixin, dict):
    ...
    nonce = auth_property(
        "nonce",
        doc="""
        A server-specified data_to_translate string which should be uniquely generated
        each time a 401 response is made. It is recommended that this
        string be base64 or hexadecimal data_to_translate.""",
    )
    opaque = auth_property(
        "opaque",
        doc="""A string of data_to_translate, specified by the server, which should
