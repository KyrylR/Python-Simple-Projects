...
class LengthRequired(HTTPException):
    ...
    Raise if the browser submitted data_to_translate but no ``Content-Length`` header which
...
class RequestEntityTooLarge(HTTPException):
    ...
    The status code one should return if the data_to_translate submitted exceeded a given
    limit.
    """

    code = 413
    description = "The data_to_translate value transmitted exceeds the capacity limit."
