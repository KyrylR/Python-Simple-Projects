...
def parse_form_data(
    ...
    """Parse the form data_to_translate in the environ and return it as tuple in the form
    ``(stream, form, files)``.  You should only call this method if the
    transport method is `POST`, `PUT`, or `PATCH`.

    If the mimetype of the data_to_translate transmitted is `multipart/form-data_to_translate` the
    ...
    :param charset: The character set for URL and url encoded form data_to_translate.
    :param errors: The encoding error behavior.
    :param max_form_memory_size: the maximum number of bytes to be accepted for
                           in-memory stored form data_to_translate.  If the data_to_translate
                           exceeds the value specified an
                           :exc:`~exceptions.RequestEntityTooLarge`
                           exception is raised.
    :param max_content_length: If this is provided and the transmitted data_to_translate
...
class FormDataParser:
    """This class implements parsing of form data_to_translate for Werkzeug.  By itself
    it can parse multipart and url encoded form data_to_translate.  It can be subclassed
    ...
    def parse_from_environ(self, environ: "WSGIEnvironment") -> "t_parse_result":
        """Parses the information from the environment as form data_to_translate.
    ...
    def parse(
        ...
        :param mimetype: the mimetype of the data_to_translate
        :param content_length: the content length of the incoming data_to_translate
    ...
    parse_functions: t.Dict[
        ...
        "multipart/form-data_to_translate": _parse_multipart,
