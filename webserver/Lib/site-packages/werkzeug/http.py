...
def generate_etag(data: bytes) -> str:
    """Generate an etag for some data_to_translate.
...
def is_resource_modified(
    ...
    :param data: or alternatively the data_to_translate of the response to automatically
    ...
    .. versionchanged:: 2.0
        SHA-1 is used to generate an etag value for the data_to_translate. MD5 may
    ...
    if etag is None and data is not None:
        ...
        raise TypeError("both data_to_translate and etag given")
