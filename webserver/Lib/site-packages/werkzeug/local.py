...
def release_local(local: t.Union["Local", "LocalStack"]) -> None:
    ...
    release data_to_translate held by proxies that way, one always has to retain
...
class LocalManager:
    ...
    cleans up, it will clean up all the data_to_translate left in the locals for this
    context.
    ...
    def cleanup(self) -> None:
        """Manually clean up the data_to_translate in the locals for this context.  Call
