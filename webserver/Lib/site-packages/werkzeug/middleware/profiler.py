...
class ProfilerMiddleware:
    ...
    data_to_translate files are saved to that directory, one file per request.
    ...
    :param profile_dir: Save profile data_to_translate files to this directory.
    :param filename_format: Format string for profile data_to_translate file names,
