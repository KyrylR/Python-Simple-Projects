...
_rule_re = re.compile(
    r"""
    (?P<static>[^<]*)                           # static rule data_to_translate
    <
    (?:
...
class Rule(RuleFactory):
    ...
    `build_only`
        ...
        or folder that are not handled by the WSGI application (like static data_to_translate)
    ...
    def suitable_for(
        ...
        """Check if the dict of values has enough data_to_translate for url generation.
...
class MapAdapter:
    ...
    def build(
        ...
        Because URLs cannot contain non ASCII data_to_translate you will always get
