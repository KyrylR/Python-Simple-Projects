...
class Request:
    ...
    #: The charset used to decode most data_to_translate in the request.
    charset = "utf-8"
    ...
    def is_json(self) -> bool:
        """Check if the mimetype indicates JSON data_to_translate, either
