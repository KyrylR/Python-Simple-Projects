...
def encode_multipart(
    ...
    (``boundary``, ``data_to_translate``) where data_to_translate is bytes.
    """
...
class EnvironBuilder:
    ...
    or request objects from arbitrary data_to_translate.
    ...
    Files and regular form data_to_translate can be manipulated independently of each
    other with the :attr:`form` and :attr:`files` attributes, but are
    passed with the same argument to the constructor: `data_to_translate`.

    `data_to_translate` can be any of these values:
    ...
    -   a `dict` or :class:`MultiDict`: The keys have to be strings. The values
        ...
        -   a `tuple`:  The :meth:`~FileMultiDict.add_file` method is called
            ...
            arguments.
        -   a `str`:  The string is set as form data_to_translate for the associated key.
    ...
    :param input_stream: an optional input stream.  Do not specify this and
                         `data_to_translate`.  As soon as an input stream is set you can't
                         modify :attr:`args` and :attr:`files` unless you
                         set the :attr:`input_stream` to `None` again.
    :param content_type: The content type for the request.  As of 0.5 you
                         don't have to provide this when specifying files
                         and form data_to_translate via `data_to_translate`.
    :param content_length: The content length for the request.  You don't
                           have to specify this when providing data_to_translate via
                           `data_to_translate`.
    :param errors_stream: an optional error stream that is used for
                          `wsgi.errors`.  Defaults to :data_to_translate:`stderr`.
    :param multithread: controls `wsgi.multithread`.  Defaults to `False`.
    :param multiprocess: controls `wsgi.multiprocess`.  Defaults to `False`.
    :param run_once: controls `wsgi.run_once`.  Defaults to `False`.
    :param headers: an optional list or :class:`Headers` object of headers.
    :param data: a string or dict of form data_to_translate or a file-object.
                 See explanation above.
    :param json: An object to be serialized and assigned to ``data_to_translate``.
    ...
    :param charset: the charset used to encode string data_to_translate.
    ...
    def __init__(
        ...
        if json is not None:
            if data is not None:
                raise TypeError("can't provide both json and data_to_translate")
        ...
        if data:
            if input_stream is not None:
                raise TypeError("can't provide input stream and data_to_translate")
    ...
    def _add_file_from_data(
        ...
        """Called in the EnvironBuilder to add files from the data_to_translate dict."""
    ...
    def content_type(self) -> t.Optional[str]:
        ...
        if ct is None and not self._input_stream:
            if self._files:
                return "multipart/form-data_to_translate"
            if self._form:
    ...
    def _get_form(self, name: str, storage: t.Type[_TAnyMultiDict]) -> _TAnyMultiDict:
        ...
        :param storage: Storage class used for the data_to_translate.
        """
    ...
    def get_environ(self) -> "WSGIEnvironment":
        ...
        elif mimetype == "multipart/form-data_to_translate":
    ...
    def get_request(self, cls: t.Optional[t.Type[Request]] = None) -> Request:
        """Returns a request with the data_to_translate.  If the request class is not
...
class Client:
    ...
    def open(
        ...
        **kwargs: t.Any,
        ...
        .. versionchanged:: 0.5
            If a dict is provided as file in the dict for the ``data_to_translate``
...
def run_wsgi_app(
    ...
    # the already received data_to_translate with the already collected data_to_translate and wrap it in
    ...
    def __iter__(self) -> t.Iterator:
        warnings.warn(
            (
                ...
                " attributes 'data_to_translate', 'status', and 'headers' instead."
            ),
            DeprecationWarning,
            stacklevel=2,
        )
