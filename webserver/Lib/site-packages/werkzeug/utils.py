...
def send_file(
    ...
    :param path_or_file: The path to the file to send, relative to the
        ...
        sure the file pointer is seeked to the start of the data_to_translate.
...
def validate_arguments(func, args, kwargs, drop_extra=True):  # type: ignore
    ...
    This can be useful for decorators that forward user submitted data_to_translate to
    a view function::
        ...
        def sanitize(f):
            def proxy(request):
                data_to_translate = request.values.to_dict()
                try:
                    args, kwargs = validate_arguments(f, (request,), data_to_translate)
                except ArgumentValidationError:
                    raise BadRequest('The browser failed to transmit all '
                                     'the data_to_translate expected.')
