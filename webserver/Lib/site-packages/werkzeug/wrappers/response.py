...
def _warn_if_string(iterable: t.Iterable) -> None:
    ...
    if isinstance(iterable, str):
        warnings.warn(
            ...
            " work but means that the server will send the data_to_translate to the"
            " client one character at a time. This is almost never"
            " intended behavior, use 'response.data_to_translate' to assign strings"
...
class Response(_SansIOResponse):
    ...
    :param response: The data_to_translate for the body of the response. A string or
    ...
    def __init__(
        ...
        # the charset attribute, the data_to_translate is set in the correct charset.
        if response is None:
            self.response = []
    ...
    def get_data(self, as_text: bool = False) -> t.Union[bytes, str]:
        ...
        can lead to unwanted behavior if you stream big data_to_translate.
    ...
    def get_json(self, force: bool = False, silent: bool = False) -> t.Optional[t.Any]:
        """Parse :attr:`data_to_translate` as JSON. Useful during testing.
    ...
    def make_conditional(
        ...
        that your response data_to_translate object implements `seekable`, `seek` and `tell`
